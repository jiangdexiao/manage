        ...
        <el-form :inline="true" class="demo-form-inline">
          ...
          <div class="BasicinFormation clear02">
            ...
            <div class="mt10">
              ...
              <el-form-item label="折扣" class="ml65">
          ...
          <div class="Full-court-b_box" v-if="tab_flag == 'goods'">
            <div class="shopbox04">
              ...
              <div class="shopbox_cen clear02">
                ...
                <div class="shopbox_have clear02" v-if="goodsResult.content != null && goodsResult.content.length > 0">
                  <!--控制点击的时候加上class名字b_active，就可以出现点击效果！！！-->
                  <div v-for="(goods, index) in goodsResult.content" @click="removeGoods(goods)" :key="index">
            ...
            <div class="Alreadychosen">
              ...
              <div class="Alreadychosen_c overflowy">
                ...
                <div class="Alreadychosen_c_have" v-if="removeGoodsList.length > 0">
                  <div v-for="(removeGoods,index) in removeGoodsList" :key="index">
                    <el-tooltip :content="removeGoods.goodsName" placement="top-start" effect="light">
                      <div class="img fl poi1">
                        <img :src="removeGoods.goodsImageUrl"/>
                        <div class="poi2 del_info" @click="deleteRemoveGoods(index, removeGoods)">X</div>
...
//          console.log('index:' + i + ',platform:' + cost.platform + ',dealer:' + cost.dealer)
...
//          console.log('start_time:' + _this.couponParams.expiration_time_start + ',end_time:' + _this.couponParams.expiration_time_end)
      ...
      if (flag == 0 || flag == 7) {
        ...
        if (_this.couponParams.cost_json.platform !== '' && 0 <= parseInt(_this.couponParams.cost_json.platform) <= 100) {
      ...
      if (flag == 0 || flag == 8) {
        ...
        if (_this.couponParams.cost_json.dealer !== '' && 0 <= parseInt(_this.couponParams.cost_json.dealer) <= 100) {
