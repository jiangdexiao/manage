  ...
  <div class="list">
    ...
    <el-col :span="24" class="toolbar">
        <el-form :inline="true" :model="form">
            ...
            <el-form-item>
                <el-input placeholder="媒体编号" :maxlength="10" v-model="form.mediaNo" ></el-input>
            </el-form-item>
            <el-form-item>
                <el-input placeholder="媒体名称" :maxlength="50" v-model="form.mediaName" ></el-input>
            </el-form-item>
            <el-form-item>
            ...
            <el-form-item>
                <el-input placeholder="促销员名/账号" :maxlength="20" v-model="form.salesmanNameOrNo" ></el-input>
            </el-form-item>
            <el-form-item>
                <el-input placeholder="BD员姓名/账号" :maxlength="20" v-model="form.bdNameOrNo" ></el-input>
            </el-form-item> 
            <el-form-item>
                <el-date-picker
                    :editable="false"
    ...
    return {
      ...
      datagrid: {
        ...
        FieldList: [
          ...
          { key: 'mediaName', label: '所属媒体名称',width:210,tooltip:true,formatter:function(row,column,cellValue){
          ...
          { key:'cooperNo', label:'合同编号',width:100},
          { key:'contractStatus', label:'合同状态',width:100,formatter:function(y,column,cellValue){
             return y.contractStatus === 1 ? '合同中' :y.contractStatus === 2 ? '合同过期' :y.contractStatus === 3 ? '终止合约':'-'
          }},
          ...
          { key: 'addr', label: '详细地址',width:300,tooltip:true,formatter:function(row,column,cellValue){
  ...
  methods: {
    onClickBtnDownload() {
      ...
      this.api_mediaManagePlatform_activatedDownLoad({
          type:'post', 
          data: Object.assign({},this.form,{type:2 ,platformType:1 }), 
    ...
    init(){
      ...
      this.api_mediaManagePlatform_activatedList({ data: Object.assign({},this.form,{type:2 ,platformType:1 }) }).then(res=>{
