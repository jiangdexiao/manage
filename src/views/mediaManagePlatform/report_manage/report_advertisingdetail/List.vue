  ...
  <div class="list tab_list">
    ...
    <el-col :span="24" class="toolbar">
        <el-form :inline="true" :model="form">
            ...
            <el-form-item>
              <el-select v-model="form.mediaLevel"  class="form-input" placeholder="媒体等级" clearable>
            ...
            <el-form-item>
              <el-select v-model="form.useStatus"  class="form-input" placeholder="广告位状态" clearable>
...
export default {
    ...
    return {
      ...
      datagrid: {
        ...
        FieldList: [
          ...
          { key:'province', label:'地区',width:210, formatter:function(y,column,cellValue){
            return y.province +' ' + y.city
          }},
          { key: 'tagAddr', label: '地址',width:350,tooltip:true,formatter:function(row,column,cellValue){
             return tool.str.textLength(row.tagAddr,20)
          }},
          { key:'cateName', label:'媒体分类',width:150, formatter:function(y,column,cellValue){
          ...
          { key:'employeeNum', label:'员工人数'},
          { key:'mresNo', label:'广告位条码',width:150},
          { key:'qrUrl', label:'广告位二维码值',width:200,tooltip:true,formatter:function( row ){
            return tool.str.textLength(row.qrUrl,20)
          }},
          ...
          { key:'formName', label:'广告位形式',width:250},
          { key:'mresCateName', label:'广告位位置',width:150},
          { key:'sizeInfo', label:'尺寸',width:150},
          { key:'contactMan', label:'联系人',width:150},
          { key:'contactTel', label:'联系方式',width:150},
          { key:'createdDate', label:'新增日期',width:150},
  ...
  methods: {
    onClickBtnDownload() {
      ...
      this.api_mediaManagePlatform_advertisingDownLoad({
    ...
    init(){
      ...
      this.api_mediaManagePlatform_advertisingDet({data:this.form}).then(res=>{
