            ...
            <el-col :span="24" >
                <el-form ref="form" :model="form" :rules="formRules"  label-width="120px">
                  <div class="bodysty">
                    ...
                    <el-form-item label="BD专员" prop="bdStaffId">  
                        <el-select v-model="form.bdStaffId" filterable remote placeholder="BD专员"  clearable :remote-method="getBdList"  >
                    ...
                    <div class="right_body">
                        ...
                        <el-form-item label="营业时间" >
                            <el-time-select
                                placeholder="起始时间" v-model="form.hourStart"
                                :picker-options="{
                                start: '00:00',
                                step: '00:30',
                                end: '23:30'
                            ...
                            <el-time-select
                                placeholder="结束时间" v-model="form.hourEnd"
                                :picker-options="{
                                start: '00:00',
                                step: '00:30',
                                end: '23:30'
                        ...
                        <el-form-item label="平日人流" prop="workDayCusts">   
                            <el-input v-model="form.workDayCusts" :maxlength="5" ><template slot="append">人</template></el-input>
                        </el-form-item>
                        <el-form-item label="周日人流" prop="weekDayCusts">
                            <el-input v-model="form.weekDayCusts" :maxlength="5" ><template slot="append">人</template></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="员工数量" prop="employeeNum">
                            <el-input v-model="form.employeeNum" :maxlength="5" ><template slot="append">人</template></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="卫生环境" prop="hygieneLevel">  
                            <el-select v-model="form.hygieneLevel" placeholder="请选择" @change="getFormLevel('hygieneLevel',form.hygieneLevel)" clearable>
                    ...
                    <h5 class="text_c" >签约信息</h5>
                     ...
                     <el-form-item label="生效时间" prop="effectDate">
                        <el-date-picker type="date" placeholder="选择日期" value-format="yyyy-MM-dd" v-model="form.effectDate" ></el-date-picker>
                    </el-form-item>
...
export default {
  ...
  methods:{
    ...
    getBdList(query){
        ...
        this.loading = true;
        this.api_mediaManagePlatform_bd({data:{keyWords:query,operateBdId: 0}}).then(res=>{
            this.loading = false;
    ...
    clear(){
        ...
        this.tool.dp.clearData(this.getLeveldata)
        this.iDays =''
    },
    save(){
          ...
          if (valid) {
              ...
              if( !this.form.mediaId ){
                  ...
                  this.api_common_mediaId({data:{prefix:this.prefix_18MD}}).then(res=>{
                      ...
                      this.api_mediaManagePlatform_media({
                        data:data,
                        type:'post',
                      }).then(res=>{
                          this.handleClose()
                  ...
                  //修改
                  this.api_mediaManagePlatform_media({data:data,type:'put',pathParams:`/${ this.form.mediaId }`}).then(res=>{
                      this.handleClose()
                      this.$emit('success',true)
                  })
              }
          ...
          if( v === true){
              if( this.data && this.data.mediaId ){
                  this.api_mediaManagePlatform_mediaDetail({pathParams:`/${ this.data.mediaId }`}).then(res=>{
                      ...
                      this.getBdList(media.bdStaffName)
                      this.bdList.push({bdName: media.bdStaffName,account:media.bdStaffNo, bdId:media.bdStaffId})
